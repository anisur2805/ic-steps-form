...
<div class="panel-body wizard-content ic-user-edit-wrapper">
    ...
    <form enctype="multipart/form-data" method="post" id="example-form" class="tab-wizard wizard-circle">
        ...
        <section class="mb-30">
            <div class="row">
                ...
                <div class="col-lg-6 mb-25">
                    ...
                    <input name="pass" id="password" type="password" class="form-control required" placeholder="Password">
                </div>
                <!-- Confirm password -->
                <div class="col-lg-6 ">
                    <label for="confirm" class="form-label">Confirm Password* <span id="password-error"></span></label>
            ...
            <div class="row ">
                ...
                <div class="col-lg-6 mb-25 condition is-children-col condition-1">
                    ...
                    <select name="have-children" class="form-select">
                        <option value="0" <?php echo ($results[0]['haveChild'] == '0') ? 'selected' : ''; ?>>Choose Options</option>
                        <option value="1" <?php echo ($results[0]['haveChild'] == '1') ? 'selected' : ''; ?>>Yes</option>
                        <option value="2" <?php echo ($results[0]['haveChild'] == '2') ? 'selected' : ''; ?>>No</option>
                    </select>
                </div>
                ...
                <div class="col-lg-6 mb-25 condition condition-2">
                    ...
                    <div class="form-radio">
                        <label for="male">
                            <input type="radio" value="male" id="male" name="first-kids-gender" class="form-check-input" <?php checked( $results[0]['first_child_gender'], 'male' ); ?> /> Male
                        </label> &nbsp;&nbsp;
                        <label for="female-1">
                            <input type="radio" value="female" id="female-1" name="first-kids-gender" class="form-check-input" <?php checked( $results[0]['first_child_gender'], 'female' ); ?> /> Female
                        </label>
                ...
                <div class="col-lg-6 mb-25 condition condition-2">
                    ...
                    <div class="form-radio">
                        ...
                        <input type="radio" value="male" id="second-male-1" name="second-kids-gender" class="form-check-input" <?php checked( $results[0]['second_child_gender'], 'male' ); ?> /> Male
                        </label> &nbsp;&nbsp;
                        <label for="second-female-2">
                        <input type="radio" value="female" id="second-female-2" name="second-kids-gender" class="form-check-input" <?php checked( $results[0]['second_child_gender'], 'female' ); ?> /> Female
                        </label>
                    </div>
                </div>
                ...
                <div class="col-lg-6 mb-25 condition condition-2">
                    ...
                    <div class="form-radio">
                        ...
                        <input type="radio" value="male" id="third-male-1" name="third-kids-gender" class="form-check-input"  <?php checked( $results[0]['third_child_gender'], 'male' ); ?>/> Male
                        </label> &nbsp;&nbsp;
                        <label for="third-female-2">
                        <input type="radio" value="female" id="third-female-2" name="third-kids-gender" class="form-check-input" <?php checked( $results[0]['third_child_gender'], 'female' ); ?> /> Female
                        </label>
                    </div>
                </div>
        ...
        <section class="mb-30">
            <div class="ic-file-upload-wrapper row">
                ...
                <div class="col-lg-6 mb-25">
                    ...
                    <select name="membership_type" id="membership_type" class="form-select required" aria-label="Default select example">
                        ...
                        <option value="ec-members" <?php echo ($results[0]['membership_type'] == 'ec-members') ? 'selected' : ''; ?>>EC Members</option>
                        <option value="general-members" <?php echo ($results[0]['membership_type'] == 'general-members') ? 'selected' : ''; ?>>General Members</option>
                        <option value="founding-members" <?php echo ($results[0]['membership_type'] == 'founding-members') ? 'selected' : ''; ?>>Founding Members</option>
                        <option value="lifetime-members" <?php echo ($results[0]['membership_type'] == 'lifetime-members') ? 'selected' : ''; ?>>Lifetime Members</option>
                    </select>
                </div>
                ...
                <div class="ic-file-upload-item">
                    ...
                    <img width="100" height="100" src="<?php echo esc_attr( wp_upload_dir()['baseurl'] . $results[0]['photo']); ?>" />
                    <input type="file" name="photo" accept="image/png, image/gif, image/jpeg, image/jpg">
                </div>

                <div class="ic-file-upload-item">
                    <h6 class="cl-pm fw-500 mb-15">NID</h6>
                    <img width="100" height="100" src="<?php echo esc_attr( wp_upload_dir()['baseurl'] . $results[0]['nid']); ?>" />
                    <input type="file" name="nid" accept="image/png, image/gif, image/jpeg, image/jpg">
                </div>
                <div class="ic-file-upload-item">
                    <h6 class="cl-pm fw-500 mb-15">Trade License</h6>
                    <img width="100" height="100" src="<?php echo esc_attr( wp_upload_dir()['baseurl'] . $results[0]['trade_license']); ?>" />
                    <input type="file" name="trade" accept="image/png, image/gif, image/jpeg, image/jpg">
                </div>
                <div class="ic-file-upload-item">
                    <h6 class="cl-pm fw-500 mb-15">CV</h6>
                    <a href="<?php echo esc_attr( wp_upload_dir()['baseurl'] . $results[0]['cv'] ); ?>" download>Download CV</a>
            ...
            <button class="button button-primary button-large" type="submit" name="update-user" id="update-user">Update Profile</button>
        </section>
    </form>
</div>